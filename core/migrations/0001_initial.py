# Generated by Django 4.2.7 on 2023-11-12 05:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('', 'select gender'), ('male', 'Male'), ('female', 'Female')], default='', max_length=10)),
                ...
                ('programming_languages', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('how_did_you_hear', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('social_media_handles', models.CharField(blank=True, choices=[('facebook', 'Facebook'), ('instagram', 'Instagram'), ('website', 'Website'), ('other', 'other')], help_text='Select one or more social media platforms.', max_length=255, null=True)),
